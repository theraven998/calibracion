...
import ReportePagina3 from "@/components/Equipo/Certificado/Reporte/Infrarrojos/Pagina3/ReportePagina3";
...
export const CertificateModalInfrarrojo: React.FC<Props> = ({
  isInfrarrojo = true,
  onClose,
  onUpload,
  headerData,
